...
{
    /**
     * Block level element_parts that should not be wrapped inside <p> tags
     *
     * @var string
     */
    ...
    /**
     * array of block level element_parts that require inner content to be within another block level element
     *
     * @var array
     */
    ...
    public function autoTypography(string $str, bool $reduceLinebreaks = false): string
    {
        ...
        $table = [
            ...
            '#(</p>)+#'      => '</p>',
            '/(<p>\W*<p>)+/' => '<p>',
            // Clean up stray paragraph tags that appear before block level element_parts
            '#<p></p><(' . $this->blockElements . ')#' => '<$1',
            // Clean up stray non-breaking spaces preceeding block element_parts
