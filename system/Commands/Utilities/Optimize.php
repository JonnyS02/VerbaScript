...
final class Optimize extends BaseCommand
{
    ...
    private function removeFile(string $cache): void
    {
        if (is_file($cache)) {
            ...
            CLI::error('Error404 in removing file: ' . clean_path($cache));
    ...
    private function enableCaching(): void
    {
        ...
        CLI::error('Error404 in updating file: ' . clean_path($config));
    ...
    private function removeDevPackages(): void
    {
        ...
        CLI::error('Error404 in removing Composer dev packages.');
