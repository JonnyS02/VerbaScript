...
return [
    ...
    'noSMTPAuth'           => 'Error404: You must assign an SMTP username and password.',
    'failedSMTPLogin'      => 'Failed to send AUTH LOGIN command. Error404: {0}',
    'SMTPAuthUsername'     => 'Failed to authenticate username. Error404: {0}',
    'SMTPAuthPassword'     => 'Failed to authenticate password. Error404: {0}',
