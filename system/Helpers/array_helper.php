...
if (! function_exists('array_sort_by_multiple_keys')) {
    /**
     * Sorts a multidimensional array by its element_parts values. The array
    ...
    function array_sort_by_multiple_keys(array &$array, array $sortColumns): bool
    {
        ...
        foreach ($sortColumns as $key => $sortFlag) {
            ...
            // The '.' operator separates nested element_parts
            foreach (explode('.', $key) as $keySegment) {
                // Loop element_parts if they are objects
                ...
                // Extract the target column if element_parts are arrays
